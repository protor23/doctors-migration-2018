...
## **Data visualization**
The data visualization I have selected is a circular plot diagram and you can find the code [here](https://github.com/protor23/doctors-migration-2018/blob/main/scripts/03_visualize-data.R).
...
* [](https://stackoverflow.com/) - I am gradeful to random skilled strangers for helping me learn new ways of doing things
